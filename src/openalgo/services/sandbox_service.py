...
from openalgo.database.auth_db import verify_api_key
from openalgo.database.apilog_db import async_log_order, executor
from openalgo.database.analyzer_db import async_log_analyzer
from openalgo.extensions import socketio
from openalgo.utils.logging import get_logger
from openalgo.services.telegram_alert_service import telegram_alert_service

# Import sandbox managers
from openalgo.sandbox.order_manager import OrderManager
from openalgo.sandbox.position_manager import PositionManager
from openalgo.sandbox.holdings_manager import HoldingsManager
from openalgo.sandbox.fund_manager import FundManager, get_user_funds
...
def sandbox_reload_squareoff_schedule() -> Tuple[bool, Dict[str, Any], int]:
    ...
    """
    try:
        from openalgo.sandbox.squareoff_thread import reload_squareoff_schedule, get_squareoff_scheduler_status
...
def sandbox_get_squareoff_status() -> Tuple[bool, Dict[str, Any], int]:
    ...
    """
    try:
        from openalgo.sandbox.squareoff_thread import get_squareoff_scheduler_status
