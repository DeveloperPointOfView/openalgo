...
from openalgo.database.settings_db import get_analyze_mode, set_analyze_mode
from openalgo.database.analyzer_db import AnalyzerLog, db_session
...
def toggle_analyzer_mode_with_auth(
    ...
    try:
        ...
        from openalgo.sandbox.execution_thread import start_execution_engine, stop_execution_engine
        from openalgo.sandbox.squareoff_thread import start_squareoff_scheduler, stop_squareoff_scheduler
