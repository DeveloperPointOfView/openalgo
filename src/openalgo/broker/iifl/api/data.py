...
from openalgo.broker.iifl.database.master_contract_db import SymToken, db_session
from flask import session  
import pandas as pd
from datetime import datetime, timedelta
from openalgo.utils.httpx_client import get_httpx_client
from openalgo.database.auth_db import get_feed_token
from openalgo.broker.iifl.baseurl import MARKET_DATA_URL
import pytz
        ...
        try:
            ...
            while current_start <= to_date:
                ...
                if not response or response.get('type') != 'success':
                    ...
                    raise Exception(f"Error from IIFL API: {response.get('description', 'Unknown error')}")
