...
def load_symbols_to_cache(broker: str) -> bool:
    ...
    try:
        ...
        from openalgo.database.token_db_enhanced import load_cache_for_broker, get_cache_stats
...
def clear_cache_on_logout():
    ...
    """
    try:
        from openalgo.database.token_db_enhanced import clear_cache, get_cache_stats
...
def refresh_cache_if_needed(broker: str):
    ...
    """
    try:
        from openalgo.database.token_db_enhanced import get_cache
