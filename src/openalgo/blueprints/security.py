...
from openalgo.database.traffic_db import IPBan, Error404Tracker, InvalidAPIKeyTracker, logs_session
from openalgo.database.settings_db import get_security_settings, set_security_settings
...
def ban_host():
    ...
    try:
        ...
        from openalgo.database.traffic_db import TrafficLog
