...
import websockets
import json
from openalgo.utils.logging import get_logger, highlight_url
import signal
import zmq
import zmq.asyncio
import threading
...
from openalgo.database.auth_db import get_broker_name
...
class WebSocketProxy:
    ...
    def __init__(self, host: str = "127.0.0.1", port: int = 8765):
        ...
        ZMQ_PORT = os.getenv('ZMQ_PORT', '5556')  # Default to 5556 if not set
