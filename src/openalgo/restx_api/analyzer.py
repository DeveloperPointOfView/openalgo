...
from openalgo.restx_api.account_schema import AnalyzerSchema, AnalyzerToggleSchema
from openalgo.services.analyzer_service import get_analyzer_status, toggle_analyzer_mode
