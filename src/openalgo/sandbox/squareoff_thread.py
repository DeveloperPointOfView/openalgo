...
from openalgo.database.sandbox_db import get_config
...
def _schedule_square_off_jobs(scheduler):
    ...
    try:
        from openalgo.sandbox.holdings_manager import process_all_t1_settlements
    ...
    try:
        from openalgo.sandbox.fund_manager import reset_all_user_funds
