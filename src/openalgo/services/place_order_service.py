...
from openalgo.database.auth_db import get_auth_token_broker
...
from openalgo.utils.api_analyzer import analyze_request, generate_order_id
from openalgo.utils.constants import (
    VALID_EXCHANGES,
    VALID_ACTIONS,
    VALID_PRICE_TYPES,
    VALID_PRODUCT_TYPES,
...
from openalgo.restx_api.schemas import OrderSchema
...
def place_order_with_auth(
    ...
    if get_analyze_mode():
        from openalgo.services.sandbox_service import sandbox_place_order
