...
import os
import urllib.parse
from openalgo.database.token_db import get_br_symbol, get_oa_symbol, get_brexchange
from openalgo.broker.fivepaisaxts.database.master_contract_db import SymToken, db_session
from flask import session  
import pandas as pd
from datetime import datetime, timedelta
from openalgo.utils.httpx_client import get_httpx_client
from openalgo.database.auth_db import get_feed_token
from openalgo.broker.wisdom.baseurl import MARKET_DATA_URL
import pytz
        ...
        try:
            ...
            while current_start <= to_date:
                ...
                if not response or response.get('type') != 'success':
                    ...
                    raise Exception(f"Error from Wisdom API: {response.get('description', 'Unknown error')}")
