...
from openalgo.broker.pocketful.mapping.transform_data import transform_data, map_product_type, reverse_map_product_type, transform_modify_order_data
...
def get_holdings(auth):
    ...
    from openalgo.broker.pocketful.mapping.order_data import transform_holdings_data
