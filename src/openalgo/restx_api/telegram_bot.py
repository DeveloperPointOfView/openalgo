...
# Lazy import telegram bot service to avoid circular import
...
def _get_telegram_bot_service():
    ...
    if telegram_bot_service is None:
        try:
            from openalgo.services.telegram_bot_service import telegram_bot_service as tbs
...
from openalgo.services.telegram_alert_service import TelegramAlertService
from openalgo.database.telegram_db import (
...
class StartBot(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            # Initialize bot
            success, message = run_async(_get_telegram_bot_service().initialize_bot(
...
class StopBot(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            # Stop bot
            success, message = run_async(_get_telegram_bot_service().stop_bot())
