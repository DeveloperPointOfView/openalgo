...
from openalgo.utils.env_check import load_and_check_env_variables  # Import the environment check function
load_and_check_env_variables()

from flask import Flask, render_template, session
from flask_wtf.csrf import CSRFProtect  # Import CSRF protection
from openalgo.extensions import socketio  # Import SocketIO
from openalgo.limiter import limiter  # Import the Limiter instance
from openalgo.cors import cors        # Import the CORS instance
from openalgo.csp import apply_csp_middleware  # Import the CSP middleware
from openalgo.utils.version import get_version  # Import version management
from openalgo.utils.latency_monitor import init_latency_monitoring  # Import latency monitoring
from openalgo.utils.traffic_logger import init_traffic_logging  # Import traffic logging
from openalgo.utils.security_middleware import init_security_middleware  # Import security middleware
from openalgo.utils.logging import get_logger, log_startup_banner, highlight_url  # Import centralized logging
from openalgo.utils.socketio_error_handler import init_socketio_error_handling  # Import Socket.IO error handler
# Import WebSocket proxy server - using relative import to avoid @ symbol issues
from openalgo.websocket_proxy.app_integration import start_websocket_proxy

from openalgo.blueprints.auth import auth_bp
from openalgo.blueprints.dashboard import dashboard_bp
from openalgo.blueprints.orders import orders_bp
from openalgo.blueprints.search import search_bp
from openalgo.blueprints.apikey import api_key_bp
from openalgo.blueprints.log import log_bp
from openalgo.blueprints.tv_json import tv_json_bp
from openalgo.blueprints.brlogin import brlogin_bp
from openalgo.blueprints.core import core_bp
from openalgo.blueprints.analyzer import analyzer_bp  # Import the analyzer blueprint
from openalgo.blueprints.settings import settings_bp  # Import the settings blueprint
from openalgo.blueprints.chartink import chartink_bp  # Import the chartink blueprint
from openalgo.blueprints.traffic import traffic_bp  # Import the traffic blueprint
from openalgo.blueprints.latency import latency_bp  # Import the latency blueprint
from openalgo.blueprints.strategy import strategy_bp  # Import the strategy blueprint
from openalgo.blueprints.master_contract_status import master_contract_status_bp  # Import the master contract status blueprint
from openalgo.blueprints.websocket_example import websocket_bp  # Import the websocket example blueprint
from openalgo.blueprints.pnltracker import pnltracker_bp  # Import the pnl tracker blueprint
from openalgo.blueprints.python_strategy import python_strategy_bp  # Import the python strategy blueprint
from openalgo.blueprints.telegram import telegram_bp  # Import the telegram blueprint
from openalgo.blueprints.security import security_bp  # Import the security blueprint
from openalgo.blueprints.sandbox import sandbox_bp  # Import the sandbox blueprint
from openalgo.services.telegram_bot_service import telegram_bot_service
from openalgo.database.telegram_db import get_bot_config

from openalgo.restx_api import api_v1_bp, api

from openalgo.database.auth_db import init_db as ensure_auth_tables_exists
from openalgo.database.user_db import init_db as ensure_user_tables_exists
from openalgo.database.symbol import init_db as ensure_master_contract_tables_exists
from openalgo.database.apilog_db import init_db as ensure_api_log_tables_exists
from openalgo.database.analyzer_db import init_db as ensure_analyzer_tables_exists
from openalgo.database.settings_db import init_db as ensure_settings_tables_exists
from openalgo.database.chartink_db import init_db as ensure_chartink_tables_exists
from openalgo.database.traffic_db import init_logs_db as ensure_traffic_logs_exists
from openalgo.database.latency_db import init_latency_db as ensure_latency_tables_exists
from openalgo.database.strategy_db import init_db as ensure_strategy_tables_exists
from openalgo.database.sandbox_db import init_db as ensure_sandbox_tables_exists

from openalgo.utils.plugin_loader import load_broker_auth_functions
...
def create_app():
    # Initialize Flask application with correct template and static folder paths
    ...
    from openalgo.cors import get_cors_config
    ...
    from openalgo.utils.number_formatter import format_indian_number
    ...
    def check_session_expiry():
        ...
        from openalgo.utils.session import is_session_valid, revoke_user_tokens
    ...
    def not_found_error(error):
        from flask import request
        from openalgo.database.traffic_db import Error404Tracker
        from openalgo.utils.ip_helper import get_real_ip
...
with app.app_context():
    try:
        from openalgo.database.settings_db import get_analyze_mode
        from openalgo.sandbox.execution_thread import start_execution_engine
        from openalgo.sandbox.squareoff_thread import start_squareoff_scheduler
        from concurrent.futures import ThreadPoolExecutor, as_completed
        import time
        ...
        if get_analyze_mode():
            ...
            def run_catchup():
                from openalgo.sandbox.position_manager import catchup_missed_settlements
