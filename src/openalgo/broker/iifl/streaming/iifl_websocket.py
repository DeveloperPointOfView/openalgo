...
from openalgo.broker.iifl.baseurl import MARKET_DATA_URL,INTERACTIVE_URL,BASE_URL


class IiflWebSocketClient:
    """
    Iifl XTS Socket.IO client for market data streaming
    ...
    def __init__(self, api_key: str, api_secret: str, user_id: str, base_url: str = None):
        """
        Initialize the Iifl XTS Socket.IO client
    ...
    def connect(self):
        ...
        try:
            ...
            self.logger.info(f"Connecting to Iifl XTS Socket.IO: {connection_url}")
            ...
            self.logger.error(f"Failed to connect to Iifl XTS Socket.IO: {e}")
            if self.on_error:
    ...
    def disconnect(self):
        ...
        self.logger.info("Disconnected from Iifl XTS Socket.IO")
    ...
    def _on_connect(self):
        ...
        self.connected = True
        self.logger.info("Connected to Iifl XTS Socket.IO")
