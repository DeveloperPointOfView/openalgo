...
from openalgo.database.token_db import get_br_symbol, get_token, get_oa_symbol
...
def authenticate_broker(api_token, api_secret, otp):
    ...
    """
    try:
        from openalgo.broker.definedge.api.auth_api import authenticate_broker as auth_broker
