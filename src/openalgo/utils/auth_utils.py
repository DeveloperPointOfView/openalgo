...
from openalgo.utils.session import get_session_expiry_time, set_session_login_time
from openalgo.database.auth_db import upsert_auth, get_feed_token as db_get_feed_token
from openalgo.database.master_contract_status_db import init_broker_status, update_status
import importlib
...
def async_master_contract_download(broker, username=None):
    ...
    Args:
        ...
        username (str | None): user whose auth token should be used for broker APIs
    """
    ...
    try:
        # Pass username to allow broker modules to fetch the correct auth token
        ...
        try:
            from openalgo.database.token_db import get_symbol_count
        ...
        try:
            from openalgo.database.master_contract_cache_hook import hook_into_master_contract_download
