...
from openalgo.database.token_db import get_symbol_info
...
class OrderManager:
    ...
    def place_order(self, order_data):
        ...
        try:
            ...
            if product == 'MIS':
                from openalgo.sandbox.squareoff_manager import SquareOffManager
            ...
            if price_type == 'MARKET':
                ...
                try:
                    from openalgo.sandbox.execution_engine import ExecutionEngine
